...
import com.gfashion.magento.entity.sales.request.MagentoShipmentReq;
import com.gfashion.magento.entity.sales.response.MagentoShipmentResp;
import com.gfashion.magento.mapper.GfMagentoOrderShipmentConverter;
...
public class MagentoShipmentClient {
    ...
    public GfShipment updateShipment(GfShipment gfShipment) throws ShipmentException {
        try {
...
//            gfShipment.setTotal_qty(totalQty);
            ...
            throw new ShipmentException(e.getStatusCode(), e.getMessage());
        } catch (Exception e) {
            throw new ShipmentException(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
        }
    }

    public GfShipment getShipmentById(Integer id) throws ShipmentException {
     ...
     */
    public GfShipmentResp queryShipments(String searchCriteria, String fileds) throws ShipmentException {
