...
public class MagentoClient {
    ...
    public MagentoClient(RestTemplate client, Gson gson) {
        restTemplate = client;
        this.gson = gson;
    }
    ...
    private String getAdminToken() {
        ...
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(baseUrl + adminTokenUrl, request, String.class);
